...
public class Enrollment implements Serializable {
    ...
    protected String toHTMLTableAssignGrades() {
        ...
        r.append(String.format("<td><input class=\"input\" type=\"number\" maxlength=\"10\" minlegnth=\"0\" name=\"%s\" placeholder=\"%d\" pattern=\"0[0-9]{9}\" title=\"Debe ingresar el formato: XX {1-10}\" required=\"required\"></td>", generateCompoundIdentifier(), getGrade()));
        r.append("</tr>");
