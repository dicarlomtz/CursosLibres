...
public class Course implements Serializable {
    ...
    public String toHTMLModify() throws IOException, SQLException
    {
        ...
        r.append("\t\t\t<tr>\n");
        r.append(String.format("\t\t\t\t<td>%d</td>\n", this.getId()));
        r.append(String.format("\t\t\t\t<td><input class=\"input-form\" name=\"courseDescription\" type=\"text\" value=\"%s\" title=\"%s\" required></input></td>\n", this.getDescription(), "Debe llenar todos los espacios"));
        ...
        r.append(String.format("\t\t\t\t<td><button class =\"bn-normal\" name=\"idCourseM\" value=\"%d\">%s</button></td>\n", this.getId(), "Modificar"));
        r.append("\t\t\t</tr>\n");
        r.append("</form>");
